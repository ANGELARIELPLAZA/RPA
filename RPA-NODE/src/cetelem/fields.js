...
const VEHICULO_FIELDS = [
    ...
    { key: "vehicleBrand", selector: "#vehicleBrand", type: "select", required: true, timeout: 30000, retries: 6, transform: normalizeString },
    ...
    { key: "vehiclePriceTax", selector: "#vehiclePriceTax", type: "input", required: true, timeout: 15000, retries: 3, transform: normalizeString },
